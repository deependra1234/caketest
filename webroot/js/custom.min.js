...
$(document).ready(function () {
    var e = function () {
        ...
        var e = $("body").outerHeight(), t = $("body").hasClass("footer_fixed") ? 0 : $("footer").height(), n = $(".left_col").eq(1).height() + $(".sidebar-footer").height(), i = n > e ? n : e;
    ...
    }), $("#sidebar-menu").find('a[href="' + CURRENT_URL + '"]').parent("li").addClass("current-page"), $("#sidebar-menu").find("a").filter(function () {
